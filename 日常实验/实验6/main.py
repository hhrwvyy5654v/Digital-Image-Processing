...
if __name__ == '__main__':
    compress("./lion.jpg","./lion")
    original_size=os.path.getsize("./lion.jpg")
    Compressed_size=os.path.getsize("./lion")
    decompress("./lion","./lion.png")
    print("图像压缩比:",Compressed_size/original_size)